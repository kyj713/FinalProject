...
public class AdminOrgController {
	...
	@PreAuthorize("hasRole('ROLE_ADMIN')")
	@DeleteMapping("/softDeleteDept")
	public ResponseEntity<String> softDeleteDept(@RequestBody Dept dept) {
		ResponseEntity<String> entity = null;
		log.debug("부서 임시삭제 컨트롤러");
		log.debug("넘어온 부서코드 : " + dept.getDeptCode());
	...
	public List<Map<String, Object>> getDeletedEmpData() {
		...
		log.debug("사원 삭제목록 : " + deletedEmpList);
