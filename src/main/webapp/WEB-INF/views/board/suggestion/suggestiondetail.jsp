                    ...
                    <%-- <div class="card mb-3">
                        <div class="card-body">
							...
							<form class="mt-4 row" action="/suggestion/replyInsert" method="post" id="insertReplyForm">
							    ...
							    <div class="col-md-4">
							        <div class="col-md-8">
							            <textarea id="suggestionReplyContent" class="form-control" rows="9" name="replyContent" placeholder="답변 내용을 작성하세요" required></textarea>
							        </div>
							        <p></p>
...
<body>         
	<form action="/suggestion/suggestiondelete" method="post" id="delForm">
		<input type="hidden" name="boardNo" value="${board.boardNo }"/>
		<sec:csrfInput />
	</form>
</body>  
...
/* 	var loggedInEmpNo = $("#loggedInEmpNo")
	...
	listBtn.on("click", function(){
		location.href = "/suggestion/suggestionlist";
	});
	        ...
	        if (confirm("정말로 삭제하시겠습니까?")) {
	            $.ajax({
	                ...
	                success: function(response) {	// 성공 시 callback
	                    ...
	                    // 예시: 답변이 삭제된 후에 특정 영역 업데이트
	                    $("#commentArea").html("<p>답변이 성공적으로 삭제되었습니다.</p>");
