        ...
        <section id="content" class="content">
            <div class="content__header content__boxed overlapping">
                <div class="content__wrap">
                    ...
                    <h1 class="page-title mb-0 mt-2">건의게시판 조회</h1>
                            ...
                            <div class="d-md-flex mt-4">
                                ...
                                <ul class="list-group list-group-borderless ms-auto">
                                    ...
                                    <li class="list-group-item d-flex justify-content-between align-items-center px-0 pt-0 pb-1">
                                        ...
                                        <span class="badge bg-success rounded-pill">${board.employee.empName}</span>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between align-items-center px-0 pt-0 pb-1">
				...
				<p></p>
                    ...
                    <div class="card mb-3">
                        <div class="card-body">
							...
							<form class="mt-4 row" action="/suggestion/replyInsert" method="post" id="insertReplyForm">
						        <input type="hidden" name="boardNo" value="${board.boardNo }" />
							    <div class="col-md-4">
							        <div class="col-md-8">
							            <textarea id="boardReplyContent" class="form-control" rows="9" name="replyContent" placeholder="답변 내용을 작성하세요" required></textarea>
							        </div>
							        <p></p>
							        <button class="btn btn-primary mb-3 mb-md-0" id="insertReplyBtn" type="submit">답변 등록하기</button>
							    </div>
							    <sec:csrfInput />
							</form>
                        </div>
...
<body>         
	<form action="/suggestion/delete" method="post" id="delForm">
		<input type="hidden" name="boardNo" value="${board.boardNo }"/>
		<sec:csrfInput />
	</form>
</body>  
...
<body>         
	<form action="/suggestion/replyDelete" method="post" id="delReplyForm">
...
/* 	var loggedInEmpNo = $("#loggedInEmpNo")
	    ...
	    delForm.prop("action", "/suggestion/update");
	    delForm.submit();
	});
	...
	listBtn.on("click", function(){
		location.href = "/suggestion/adsuggestionlist";
	});
	...
	$(".fileDownload").on("click", function(){
		...
		console.log($(this))
		console.log(fileNo)
		location.href = "/suggestion/download.do?fileNo="+fileNo;
	});
...
/* 	var updateReplyForm = $("#updateReplyForm");
	...
	insertReplyBtn.on("click", function() {
		var suggestionReplyContent = $("#boardReplyContent").val();
		console.log("suggestionReplyContent : " + suggestionReplyContent);

		if (suggestionReplyContent == null || suggestionReplyContent == "") {
			alert("내용을 입력해주세요.");
			return false;
		}
