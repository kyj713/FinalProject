	...
	<!-- Breadcrumb -->
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb mb-0">
				...
				<li class="breadcrumb-item active" aria-current="page">건의게시판 관리</li>
			</ol>
		</nav>
		<!-- Breadcrumb 끝-->
...
<!-- 												</td> -->
												...
												<td class="text-center"><a
													href="/suggestion/adsuggestiondetail?boardNo=${board.boardNo }">${board.boardTitle}</a></td>
												<%--  <td class="text-center">${board.empNo}</td>  --%>
												<td class="text-center">${board.empName}</td>																	
