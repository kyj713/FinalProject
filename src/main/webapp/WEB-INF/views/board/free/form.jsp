	...
	<div class="content__wrap">
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb mb-0">
				...
				<li class="breadcrumb-item"><a href="./forms.html">자유게시판</a></li>
				<li class="breadcrumb-item active" aria-current="page">자유게시글 등록하기</li>
			</ol>
		</nav>
	</div>
</div>
...
<div class="content__boxed">
	<div class="content__wrap">
		...
		<form action="/board/insert" method="post" id="insertForm"
			...
			<input type="hidden" value="${board.boardCode } == 2">
			<c:if test="${status eq 'u' }">
...
$(function() {
	...
	$(".fileDelete").on("click", function(){
		...
		insertBtn.on("click", function() {
			...
			if ($(this).val() == "수정") {
				insertForm.attr("action", "/board/update");
			}
