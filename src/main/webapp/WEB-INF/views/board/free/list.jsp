...
<body>
	<div class="content__header content__boxed overlapping">
		<div class="content__wrap">
			...
			<!-- 주제와 설명 -->
			<h1 class="page-title d-flex flex-wrap just justify-content-center mb-2 mt-4">자유게시판</h1>
			<p class="text-center">회사에 근무중인 모든 직원이 자유롭게 사용 가능한 게시판입니다.</p>
			<!-- 주제와 설명 끝 -->
						...
						<table class="table table-striped align-middle">
							...
							<thead>
								<tr>
									...
									<th class="text-center" width="10%">작성날짜</th>
