...
$(function() {
	...
	deptDelBtn.on("click", function() {
		...
		if(selectArr.length == 0) {	// 노드를 선택하지 않았을 경우
			...
			Swal.fire({
                icon: 'warning',
                html: '삭제된 이후 부서 데이터는<br> [삭제 부서 목록]에서 이관할 수 있습니다.<br> 부서를 삭제하시겠습니까?',
               	showCancelButton: true,
