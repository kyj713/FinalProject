		...
		<div class="content__wrap">
			...
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb mb-0">
					...
					<li class="breadcrumb-item active" aria-current="page">진행중인 설문</li>
				</ol>
			</nav>
			<!-- 상위에 표시된 해당 페이지 경로 끝 -->

			<!-- 주제와 설명 -->
			<h1 class="page-title d-flex flex-wrap just justify-content-center mb-2 mt-4">진행중인 설문</h1>
			<p class="text-center">진행중인 설문을 확인할 수 있으며 설문대상에 한해서 참여가 가능합니다.</p>
			<!-- 주제와 설명 끝 -->
...
<!-- 게시글 끝 -->
							...
							<tbody>
								...
								<c:choose>
									<c:when test="${empty boardList }">
										<tr>
											<td colspan="5">조회하신 설문이 존재하지 않습니다...</td>
										</tr>
									</c:when>
									<c:otherwise>
										<c:forEach items="${boardList }" var="board">
